...
def get_point_tibia_left(img):
    ...
    contours, _ = cv2.findContours(left_image, cv2.RETR_LIST, cv2.CHAIN_APPROX_SIMPLE)
...
rotula_left, rotula_right = get_points_rotula_left(ds2)
basic_rotulian(ds2, femur_left, femur_right, rotula_left, rotula_right)
